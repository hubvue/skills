---
name: painpoint-validate
description: Validate whether pain points are real, frequent, severe, and poorly solved today. Use when the idea-to-requirement workflow reaches the `painpoint_validate` stage, or when independently producing `04-painpoints.md` from upstream stage documents.
...
Validate whether pain points are real, frequent, severe, and poorly solved today.
...
Use this skill when the workflow reaches stage `painpoint_validate` or when you need to independently produce `04-painpoints.md` from the required upstream documents.
...
6. Always write the stage document to `04-painpoints.md`.
...
- Stage document: `04-painpoints.md`
- Research document: `research/04-painpoints-research.md` when search is used or when evidence must be documented.
