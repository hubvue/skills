---
name: idea-intake
description: Record a raw idea, create the idea workspace, and initialize status and source files. Use when capturing a new raw idea, or when the idea-to-requirement workflow reaches the `idea_intake` stage to produce `00-idea-intake.md`.
...
Record a raw idea, create idea workspace, initialize status and source files.
...
Use this skill when capturing a new raw idea, or when the idea-to-requirement workflow reaches stage `idea_intake`. This is the first stage and has no upstream documents; its only input is the user's raw idea.

## Operating Rules

1. Record the user's raw idea; this stage has no upstream documents to read.
...
6. Always write the stage document to `00-idea-intake.md`.
...
- Stage document: `00-idea-intake.md`
- Research document: `research/00-idea-intake-research.md` when search is used or when evidence must be documented.
