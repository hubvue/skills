---
name: motivation-clarify
description: Clarify why the idea exists and what external background or trigger supports it. Use when the idea-to-requirement workflow reaches the `motivation_clarify` stage, or when independently producing `01-motivation.md` from upstream stage documents.
...
Clarify why the idea exists and what external background or trigger supports it.
...
Use this skill when the workflow reaches stage `motivation_clarify` or when you need to independently produce `01-motivation.md` from the required upstream documents.
...
6. Always write the stage document to `01-motivation.md`.
...
- Stage document: `01-motivation.md`
- Research document: `research/01-motivation-research.md` when search is used or when evidence must be documented.
