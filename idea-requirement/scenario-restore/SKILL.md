---
name: scenario-restore
description: Restore realistic user scenarios, current workflow, target workflow, and trigger moments. Use when the idea-to-requirement workflow reaches the `scenario_restore` stage, or when independently producing `03-scenarios.md` from upstream stage documents.
...
Restore realistic user scenarios, current workflow, target workflow, and trigger moments.
...
Use this skill when the workflow reaches stage `scenario_restore` or when you need to independently produce `03-scenarios.md` from the required upstream documents.
...
6. Always write the stage document to `03-scenarios.md`.
...
- Stage document: `03-scenarios.md`
- Research document: `research/03-scenarios-research.md` when search is used or when evidence must be documented.
