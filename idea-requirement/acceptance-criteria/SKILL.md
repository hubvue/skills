...
description: Define functional, process, exception, and non-functional acceptance criteria and DoD. Use when the idea-to-requirement workflow reaches the `acceptance_criteria` stage, or when independently producing `10-acceptance.md` from upstream stage documents.
...
Define functional, process, exception, non-functional acceptance criteria and DoD.
...
Use this skill when the workflow reaches stage `acceptance_criteria` or when you need to independently produce `10-acceptance.md` from the required upstream documents.
...
6. Always write the stage document to `10-acceptance.md`.
...
- Stage document: `10-acceptance.md`
- Research document: `research/10-acceptance-research.md` when search is used or when evidence must be documented.
